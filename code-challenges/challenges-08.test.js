...
const typeNum = (arr) => {
  let numberArray = arr.filter( function(n,i) {
...
const containsAnd = (arr) => {
  let andArray = arr.filter( function(n,i) {
...
const oddValues = (arr) => {
  let oddArray = arr.filter( function(n,i) {
    return (n % 2);
  });
 return oddArray;
};
...
const filterStringsWithVowels = (arr) => {
  let vowelsArray = arr.filter( function(n,i){
    return n == /(a,e,i,u,o)/g;
  })
  return vowelsArray;
};
